...
function App() {
  const data = [
    ...
    },
    {
      ...
      description:
        "In todays data-driven world, data science has emerged as a crucial field, with companies harnessing",
      date: "10 November 2023 ",
      content: "Data Science",
    },
    {
   ...
   
    {
      ...
      description:
        "Todays world is rapidly evolving into a technological landscape. Owing to these dynamics, the demand",
      date: "31 August 2023",
      content: "Full Stack Development",
    },
...

    {
      ...
      description:
        "Today, were going to talk about something really cool: data science. Its all about using",
